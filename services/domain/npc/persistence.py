...
class NPCPersistence:
        ...
        try:
            ...
            """,
                (
                    ...
                    npc_template.get("hp", 10),
                    npc_template.get("hp", 10),
                    npc_template.get("ac", 10),
                    npc_template.get("speed", 30),
    ...
    def get_location_npcs(
        self, campaign_id: uuid.UUID, location_entity_id: uuid.UUID
    ) -> list[dict]:
        rows = execute_query(
            """
